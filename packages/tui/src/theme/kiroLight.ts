...
export const kiroLight: Theme = {
  colors: {
    ...
    muted: { truecolor: '#626262', color256: 241 },
    ...
    highlight: { truecolor: '#005fff', color256: 27 },
    components: {
      promptChip: {
        background: { truecolor: '#8700FF', color256: 93 },
        text: { truecolor: '#EEEEEE', color256: 255 },
      },
      snackbar: {
    ...
    diff: {
      added: {
        ...
        highlight: { truecolor: '#c0e8c0', color256: 15 }, // diffEditor.insertedTextBackground - medium green
      },
      removed: {

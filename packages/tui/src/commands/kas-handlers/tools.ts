 ...
 * notification and cached in the store's `toolsList` by `KasAcpClient`, kept
 * current on agent swaps / MCP changes. The panel re-renders automatically if a
 * later notification updates the list while it is open.
 *

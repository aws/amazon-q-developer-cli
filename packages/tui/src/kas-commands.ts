...
export const KAS_COMMANDS: readonly KasCommand[] = [
  ...
  },
  {
    ...
    meta: {
      ...
      local: true,
      localOnly: true,
      hint: '[run <recipe> | list | new <description> | retry [workflowId]]',
      subcommands: ['run', 'list', 'new', 'retry'],
      subcommandDescriptions: {
        run: 'Run a workflow recipe',
        list: 'Browse workflow history',
        new: 'Create a new workflow recipe',
  ...
  },
  {
    ...
    feature: Feature.Workflows,
    meta: { local: true, localOnly: true, hidden: true },
  },
  {

...
Each group shows its percentage of the context window and tool count, and individual tools within the group show their own percentage:

```
Tools
  Built-in 3.2% · 12 tools
    · read 0.8%
    · write 0.6%
    · grep 0.4%
    ...
  docs-server 1.1% · 2 tools
    · search_docs 0.6%
    · fetch_docs 0.5%
```

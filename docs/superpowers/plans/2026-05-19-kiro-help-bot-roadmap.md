...
| **3** | [2026-05-19-phase-3-ingest-pipeline.md](2026-05-19-phase-3-ingest-pipeline.md) | **next** | Hourly Lambda keeps the corpus current |
| 4 | [2026-05-19-phase-4-cross-task-coordinator.md](2026-05-19-phase-4-cross-task-coordinator.md) | planned | DynamoDB-backed leases + transcripts; 2-task HA |
| 5 | [2026-05-19-phase-5-eval-and-release-automation.md](2026-05-19-phase-5-eval-and-release-automation.md) | planned | Eval suite + GH Actions + CodeBuild → no more local `finch push` |
| 6 | [2026-05-19-phase-6-production-hardening.md](2026-05-19-phase-6-production-hardening.md) | planned | Remaining 7 tools, alarms, beta+prod split, runbooks |

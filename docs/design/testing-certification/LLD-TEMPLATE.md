<!--
  LLD TEMPLATE — copy this file, do not edit it in place.
    cp LLD-TEMPLATE.md 1X-lld-<your-workstream>.md
  Then delete this comment and every "> FILL:" line as you answer it.

  Frontmatter is MACHINE-READ by scripts/testing-cert-status (and by agents).
...
doc_type: lld
id: 1X
title: <Workstream name> — Low-Level Design
owner: TBD
status: not-started
depends_on: []          # doc ids or foundation ids, e.g. ["F1", "10"]
unblocks: []            # doc ids that cannot start until this is approved
foundations_used: []    # F1 | F2 | F3 | F4
hld: 00-hld.md
plan_phase: 0           # which phase of 02-implementation-plan.md this lands in
---

# <Workstream name> — Low-Level Design

Status: Not Started · Owner: TBD · Date: <YYYY-MM-DD>

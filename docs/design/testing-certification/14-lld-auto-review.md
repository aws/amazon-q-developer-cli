...
doc_type: lld
id: 14
title: Auto-Review Enhancements (inline comments, scenario-gap detection) — Low-Level Design
owner: TBD
status: not-started
depends_on: ["10","12"]
unblocks: []
...
# Auto-Review Enhancements (inline comments, scenario-gap detection) — Low-Level Design

...
doc_meta:
  ...
  related: [key-bindings-settings, chat-interface-settings]
...
Kiro CLI supports readline-style keyboard shortcuts for efficient text editing in the chat prompt.
...
- [Key Bindings Settings](../settings/key-bindings-settings.md) - Configurable shortcut keys
- [Chat Interface Settings](../settings/chat-interface-settings.md) - Chat UI configuration

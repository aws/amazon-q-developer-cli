...
#[test]
#[cfg(feature = "context")]
fn test_context_command() -> Result<(), Box<dyn std::error::Error>> {
    println!("🔍 Testing context commands...");
    ...
    test_context_show_command(&mut chat)?;
    test_context_help_command(&mut chat)?;
    test_context_without_subcommand(&mut chat)?;
    test_context_invalid_command(&mut chat)?;
    test_add_non_existing_file_context(&mut chat, non_existing_file_path)?;
    test_context_remove_command_of_non_existent_file(&mut chat)?;
    test_add_remove_file_context(&mut chat, test_file_path)?;
    test_add_glob_pattern_file_context(&mut chat, glob_pattern)?;
    test_add_remove_multiple_file_context(&mut chat, test_file1_path, test_file2_path, test_file3_path)?;
    test_clear_context_command(&mut chat, test_file1_path, test_file2_path)?;
...
fn test_context_show_command(chat: &mut QChatSession) -> Result<(), Box<dyn std::error::Error>> {
...
fn test_context_help_command(chat: &mut QChatSession) -> Result<(), Box<dyn std::error::Error>> {
...
fn test_context_without_subcommand(chat: &mut QChatSession) -> Result<(), Box<dyn std::error::Error>> {
...
fn test_context_invalid_command(chat: &mut QChatSession) -> Result<(), Box<dyn std::error::Error>> {
...
fn test_add_non_existing_file_context(chat: &mut QChatSession, non_existing_file_path: &str) -> Result<(), Box<dyn std::error::Error>> {
...
fn test_context_remove_command_of_non_existent_file(chat: &mut QChatSession) -> Result<(), Box<dyn std::error::Error>> {
...
fn test_add_remove_file_context(chat: &mut QChatSession, test_file_path: &str) -> Result<(), Box<dyn std::error::Error>> {
...
fn test_add_glob_pattern_file_context(chat: &mut QChatSession, glob_pattern: &str) -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Verify glob pattern was removed successfully
    assert!(remove_response.contains("Removed 1 path(s) from context"), "Missing success message for removing glob pattern");
...
fn test_add_remove_multiple_file_context(chat: &mut QChatSession, test_file1_path: &str, test_file2_path: &str, test_file3_path: &str) -> Result<(), Box<dyn std::error::Error>> {
...
fn test_clear_context_command(chat: &mut QChatSession, test_file1_path: &str, test_file2_path: &str) -> Result<(), Box<dyn std::error::Error>> {

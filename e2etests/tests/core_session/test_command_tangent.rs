...
println!("\n🔍 Testing tangent ... | Description: Tests the /tangent command.");
...
assert!(response.contains("Created a conversation checkpoint") || response.contains("Restored conversation from checkpoint (↯)"), "Expected checkpoint message");

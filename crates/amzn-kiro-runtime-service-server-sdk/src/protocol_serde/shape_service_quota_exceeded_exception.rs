...
pub fn ser_service_quota_exceeded_exception_error(
    ...
    crate::protocol_serde::shape_service_quota_exceeded_exception::ser_service_quota_exceeded_exception(
        &mut object,
        value,
    )?;
    object
        .key("__type")
        .string("com.amazon.kiro.runtimeservice#ServiceQuotaExceededException");
    object.finish();
    Ok(out)
}

...
pub(crate) fn de_reasoning_content<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<
    Option<crate::model::ReasoningContent>,
            ...
            match tokens.next().transpose()? {
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "reasoningText" => Some(crate::model::ReasoningContent::ReasoningText(
                            crate::protocol_serde::shape_reasoning_text::de_reasoning_text(tokens, _value, depth + 1)?
                                .ok_or_else(|| {
                        ...
                        "redactedContent" => Some(crate::model::ReasoningContent::RedactedContent(

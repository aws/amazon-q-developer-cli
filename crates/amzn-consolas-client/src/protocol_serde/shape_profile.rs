                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "identityDetails" => {
                                builder = builder.set_identity_details(
                                    crate::protocol_serde::shape_identity_details::de_identity_details(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "referenceTrackerConfiguration" => {
                                ...
                                crate::protocol_serde::shape_reference_tracker_configuration::de_reference_tracker_configuration(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                            ...
                            "activeFunctionalities" => {
                                ...
                                crate::protocol_serde::shape_active_functionality_list::de_active_functionality_list(tokens, _value, depth + 1)?,
                            );
                            },
                            "status" => {
                            ...
                            "optInFeatures" => {
                                builder = builder.set_opt_in_features(
                                    crate::protocol_serde::shape_opt_in_features::de_opt_in_features(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "applicationProperties" => {
                                ...
                                crate::protocol_serde::shape_application_properties_list::de_application_properties_list(tokens, _value, depth + 1)?,
                            );
                            },

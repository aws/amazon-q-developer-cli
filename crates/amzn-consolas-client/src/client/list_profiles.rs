...
impl super::Client {
    ...
    ///   - [`opt_in_features_type(OptInFeaturesType)`](crate::operation::list_profiles::builders::ListProfilesFluentBuilder::opt_in_features_type) / [`set_opt_in_features_type(Option<OptInFeaturesType>)`](crate::operation::list_profiles::builders::ListProfilesFluentBuilder::set_opt_in_features_type):<br>required: **false**<br>(undocumented)<br>

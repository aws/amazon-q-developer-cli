...
/// Orchestration and serialization glue logic for `InvokeMCP`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct InvokeMCP;
impl InvokeMCP {
    /// Creates a new `InvokeMCP`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::invoke_mcp::InvokeMCPError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::invoke_mcp::InvokeMcpOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CodeWhispererStreaming", "InvokeMCP", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "CodeWhispererStreaming.InvokeMCP",
                "rpc.service" = "CodeWhispererStreaming",
                "rpc.method" = "InvokeMCP",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for InvokeMCP {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("InvokeMCP");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            InvokeMCPRequestSerializer,
        ));
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(InvokeMCPResponseDeserializer),
        );

        cfg.store_put(
            ::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
                crate::config::auth::Params::builder()
                    .operation_name("InvokeMCP")
                    .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("InvokeMCP")
            .with_interceptor(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            )
            .with_interceptor(InvokeMCPEndpointParamsInterceptor)
...
#[derive(Debug)]
struct InvokeMCPResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for InvokeMCPResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_invoke_mcp::de_invoke_mcp_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_invoke_mcp::de_invoke_mcp_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct InvokeMCPRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for InvokeMCPRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::invoke_mcp::InvokeMcpInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::invoke_mcp::InvokeMcpInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_invoke_mcp::ser_invoke_mcp_input(&input)?,
        );
...
#[derive(Debug)]
struct InvokeMCPEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for InvokeMCPEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "InvokeMCPEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<InvokeMcpInput>()
            .ok_or("failed to downcast to InvokeMcpInput")?;
...
/// Error type for the `InvokeMCPError` operation.
#[non_exhaustive]
...
pub enum InvokeMCPError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-InvokeMCPError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl InvokeMCPError {
    /// Creates the `InvokeMCPError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `InvokeMCPError::Unhandled` variant from an
...
impl ::aws_smithy_types::retry::ProvideErrorKind for InvokeMCPError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for InvokeMCPError {
...
impl ::aws_types::request_id::RequestId for crate::operation::invoke_mcp::InvokeMCPError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::invoke_mcp::_invoke_mcp_input::InvokeMcpInput;
pub use crate::operation::invoke_mcp::_invoke_mcp_output::InvokeMcpOutput;

mod _invoke_mcp_input;

mod _invoke_mcp_output;

        ...
        match response_headers.message_type.as_str() {
            "event" => match response_headers.smithy_type.as_str() {
                "binaryMetadataEvent" => {
                    ...
                    .map_err(|err| {
                        ::aws_smithy_eventstream::error::Error::unmarshalling(format!(
                            "failed to unmarshall BinaryMetadataEvent: {err}"
                        ))
                    })?;
                ...
                "binaryPayloadEvent" => {
                    ...
                    .map_err(|err| {
                        ::aws_smithy_eventstream::error::Error::unmarshalling(format!(
                            "failed to unmarshall BinaryPayloadEvent: {err}"
                        ))
                    })?;
                    Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Event(
            ...
            "exception" => {
                ...
                if response_headers.smithy_type.as_str() == "internalServerException" {
                    ...
                    .map_err(|err| {
                        ::aws_smithy_eventstream::error::Error::unmarshalling(format!(
                            "failed to unmarshall internalServerException: {err}"
                        ))
                    })?;
        ...
        match response_headers.message_type.as_str() {
            "event" => match response_headers.smithy_type.as_str() {
                ...
                "documentCitationEvent" => {
                    let parsed =
                        crate::protocol_serde::shape_document_citation_event::de_document_citation_event_payload(
                            &message.payload()[..],
                        )
                        .map_err(|err| {
                            ::aws_smithy_eventstream::error::Error::unmarshalling(format!(
                                "failed to unmarshall DocumentCitationEvent: {err}"
                            ))
                        })?;
                    Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Event(
                        crate::types::ChatResponseStream::DocumentCitationEvent(parsed),
                    ))
                },
                "invalidStateEvent" => {

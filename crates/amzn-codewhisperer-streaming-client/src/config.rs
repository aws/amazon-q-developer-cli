...
impl Builder {
    ...
    /// impl amzn_codewhisperer_streaming_client::config::auth::ResolveAuthScheme
    ///     for CustomAuthSchemeResolver
    /// {
    ///     fn resolve_auth_scheme<'a>(
    ///         &'a self,
    ///         _params: &'a amzn_codewhisperer_streaming_client::config::auth::Params,
    ///         _cfg: &'a ConfigBag,
    ///         _runtime_components: &'a RuntimeComponents,
    ...
    /// partition named `codewhispererstreaming` (or `codewhispererstreaming-<region>` if a
    /// region is configured). All CodeWhispererStreaming clients without an explicit retry
    /// partition will share this default partition.
    ///
    /// # Notes
    ///
    ...
    /// ```no_run
    /// use amzn_codewhisperer_streaming_client::config::Config;
    /// use amzn_codewhisperer_streaming_client::config::retry::{
    ///     RetryPartition,
    ///     TokenBucket,
    /// };
    ///
    ...
    /// #    fn meta(&self) -> &amzn_codewhisperer_streaming_client::error::ErrorMetadata { todo!() }
    /// # }
    ///
...
impl ServiceRuntimePlugin {
    pub fn new(_service_config: crate::config::Config) -> Self {
        let config = {
            let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AmazonCodeWhispererStreamingService");
...
pub(crate) fn base_client_runtime_plugins(
    ...
    let scope = "amzn-codewhisperer-streaming-client";

...
impl super::Client {
    ...
    ///   - [`additional_model_request_fields(Document)`](crate::operation::generate_assistant_response::builders::GenerateAssistantResponseFluentBuilder::additional_model_request_fields) / [`set_additional_model_request_fields(Option<Document>)`](crate::operation::generate_assistant_response::builders::GenerateAssistantResponseFluentBuilder::set_additional_model_request_fields):<br>required: **false**<br>Additional model request fields (e.g. thinking, effort) to pass to the model provider. Validated against the model's schema before merging with server defaults; throws ValidationException if invalid.<br>
    ///   - [`system_prompt(impl Into<String>)`](crate::operation::generate_assistant_response::builders::GenerateAssistantResponseFluentBuilder::system_prompt) / [`set_system_prompt(Option<String>)`](crate::operation::generate_assistant_response::builders::GenerateAssistantResponseFluentBuilder::set_system_prompt):<br>required: **false**<br>Optional system prompt from the client. Appended to the server-side system prompt.<br>

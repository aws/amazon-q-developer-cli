...
pub fn catalog_metric_records() -> Vec<MetricRecord> {
    ...
    vec![
        ...
        record_stream_stall(interface, AcpClient::Kirocrew, engine, model, StallTier::Hard),
        record_stream_stall_idle_seconds(
            120.0,
            interface,
            AcpClient::Kirocrew,
            engine,
            model,
            StallEpisodeEnd::HardCancelled,
        ),
        record_stream_stall_idle_seconds(
            30.0,
            interface,
        ...
        record_stream_stall_idle_seconds(
            ...
            engine,
            model,
            StallEpisodeEnd::Cancelled,
        ),
        record_stream_stall_retry(
            interface,
            AcpClient::Kirocrew,
            engine,
            model,
            RetryOutcome::Recovered,
            AttemptNumberBucket::First,
            PartialOutput::No,
        ),
        record_stream_stall_recovery_seconds(3.5, interface, AcpClient::Kirocrew, engine, model),
        record_subagent_deadline_expired(3600.0, engine),
        record_transient_retry(
            interface,
            AcpClient::Kirocrew,
            engine,
            model,
            TransientErrorClass::Throttle,
            AttemptNumberBucket::First,

...
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError>
{
    ...
    crate::protocol_serde::shape_list_available_subscriptions_input::ser_list_available_subscriptions_input_input(
        &mut object,
        input,
    )?;
    object.finish();
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "subscriptionPlans" => {
                    builder = builder.set_subscription_plans(
                        crate::protocol_serde::shape_subscription_plan_list::de_subscription_plan_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,

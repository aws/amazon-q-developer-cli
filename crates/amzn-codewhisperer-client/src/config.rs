...
impl Builder {
    ...
    /// impl amzn_codewhisperer_client::config::auth::ResolveAuthScheme for CustomAuthSchemeResolver {
    ///     fn resolve_auth_scheme<'a>(
    ///         &'a self,
    ///         _params: &'a amzn_codewhisperer_client::config::auth::Params,
    ///         _cfg: &'a ConfigBag,
    ///         _runtime_components: &'a RuntimeComponents,
    ...
    /// resolution rules for `amzn_codewhisperer_client`.
    ///
    ///
    ...
    /// partition named `codewhispererruntime` (or `codewhispererruntime-<region>` if a region
    /// is configured). All CodeWhispererRuntime clients without an explicit retry partition
    /// will share this default partition.
    ///
    /// # Notes
    ///
    ...
    /// ```no_run
    /// use amzn_codewhisperer_client::config::Config;
    /// use amzn_codewhisperer_client::config::retry::{
    ///     RetryPartition,
    ///     TokenBucket,
    /// };
    ///
    ...
    /// #    fn meta(&self) -> &amzn_codewhisperer_client::error::ErrorMetadata { todo!() }
    /// # }
    ///

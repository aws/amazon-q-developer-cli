...
impl super::Client {
    ...
    ///   - [`profile_arn(impl Into<String>)`](crate::operation::create_subscription_token::builders::CreateSubscriptionTokenFluentBuilder::profile_arn) / [`set_profile_arn(Option<String>)`](crate::operation::create_subscription_token::builders::CreateSubscriptionTokenFluentBuilder::set_profile_arn):<br>required: **false**<br>(undocumented)<br>
    ...
    ///   - [`credit_quantity(i64)`](crate::operation::create_subscription_token::builders::CreateSubscriptionTokenFluentBuilder::credit_quantity) / [`set_credit_quantity(Option<i64>)`](crate::operation::create_subscription_token::builders::CreateSubscriptionTokenFluentBuilder::set_credit_quantity):<br>required: **false**<br>Number of credits to purchase. Required when provider is STRIPE_CREDITS.<br>

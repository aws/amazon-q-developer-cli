...
pub const MIGRATION_INFO_URL: &str = "https://kiro.dev/cli";
...
2. Wait until next month when your limit automatically resets.",
    ...
    pub fn extra_help() -> String {
        ...
        help.push_str(&format!(
            "💡 Did you know, You can now configure {PRODUCT_NAME} to use MCP servers. Learn how at {}",
            StyledText::brand(super::KIRO_MCP_DOCS_URL)
        ));

...
/// Apple's preference-domain convention. It is CLI-specific rather than a bundle ID:
/// this binary has no app bundle, and a shared domain lets one MDM profile cover
/// every Kiro CLI binary.
///

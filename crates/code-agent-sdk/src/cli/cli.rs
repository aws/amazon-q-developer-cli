    ...
    match cli.command {
        ...
        Commands::GotoDefinition {
                ...
                .await?
            {
                ...
                None => {
                    println!("No definition found at {}:{}:{}", file.display(), row, column);
                },
            }
        },
        ...
        Commands::RenameSymbol {
            ...
            match code_intel.rename_symbol(request).await? {
                ...
                None => {
                    println!("Cannot rename symbol at {}:{}:{}", file.display(), row, column);
                },
            }
        },
        ...
        Commands::FormatCode {
            ...
            if edit_count == 0 {
                ...
                println!("Applied formatting to {edit_count} lines");
        ...
        Commands::GetDiagnostics { file, identifier } => {
            ...
            if diagnostics.is_empty() {
                ...
                for diagnostic in diagnostics {
                    ...
                    println!(
                        "  {} at {}:{} - {}",
                        severity, diagnostic.start_row, diagnostic.start_column, diagnostic.message
                    );

...
pub async fn read_lsp_message<R: tokio::io::AsyncRead + Unpin>(reader: &mut BufReader<R>) -> Result<String> {
...
pub async fn write_lsp_message<W: AsyncWriteExt + Unpin>(writer: &mut W, content: &str) -> Result<()> {
